            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="relative w-full h-full min-h-0 flex items-center justify-center">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className={`relative w-full h-full flex items-center justify-center min-h-[1000px] translate-y-1/3 left-1/2 -translate-x-1/2 ${['copy','googleAds'].includes(activeService.id) ? '-translate-x-20' : ''}`}> 
                      <Image
